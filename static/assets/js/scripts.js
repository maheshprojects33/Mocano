...
(function($) {
    ...
    function slider_area() {
        $('.slider-area').owlCarousel({
            ...
            items: 1,
            smartSpeed: 800,
            navText: ['<i><img src="static/assets/images/angle-left.png" alt="icon"/></i><span>prev</span>', '<span>next</span><i><img src="static/assets/images/angle-right.png" alt="icon"/></i>']
        });
    };
    slider_area();
